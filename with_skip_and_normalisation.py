...
print(layer_normalization_sequence(jnp.array([[1,2,3,4,5], [5,6,7,8,9]])))
...
[accuracy(jnp.array(x), jnp.array(y), model_parameters) for x, y in zip(mit.chunked(train_sequences[:50], 10), mit.chunked(train_labels[:50], 10))]
